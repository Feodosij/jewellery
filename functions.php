...
function jewellery_shop_setup() {
	/*
		...
		* to change 'jewellery-shop' to the name of your theme in all the template files.
		*/
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'jewellery_shop_custom_background_args',
			array(
 ...
 */
function jewellery_shop_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'jewellery_shop_content_width', 640 );
}
add_action( 'after_setup_theme', 'jewellery_shop_content_width', 0 );
...
function jewellery_shop_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'jewellery-shop' ),
			'id'            => 'sidebar-1',
